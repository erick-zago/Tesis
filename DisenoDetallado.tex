...
La arquitectura aplicativa requerida para un proceso de extracción, transformación y carga de datos está comprendida por una herramienta ETL yalgunos componentes de software adicionales para lograr la integración de la solución.
...
\subsection{Servicios de la capa de trabajos programados (\texttt{Jobs})
...
\subsubsection{Reinicio / Recuperación}
...
Esta capa se divide en 4 grandes módulos que contienen toda la lógica de negocio los suales son:
\begin{enumerate}
\item Extracción
\Limpieza.
\Transformación.
...
\subsection{Móduulo de extracción}
...
\item Adaptadores de funete de datos.
\item Filtrado y busqueda de datos.
